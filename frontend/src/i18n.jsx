...
const DICTIONARIES = {
  ja: {
    ...
    Saved: "貯金済み",
    "Goal deadline": "目標の期限",
    "Payment reminder": "支払いリマインダー",
    "Recurring saving": "定期貯金",
    "Schedule & Reminders": "予定とリマインダー",
    "Calendar event legend": "カレンダー予定の凡例",
    "No-spend day": "支出ゼロの日",
    "No-spend": "支出ゼロ",
    "Low spending": "支出少",
    "High spending": "支出多",
    "Spending heatmap": "支出ヒートマップ",
    "Daily budget limit": "1日の予算上限",
    "Daily budget": "1日の予算",
    "Calculated from your Planner monthly budgets": "プランナーの月間予算から計算",
    "Set a monthly budget in Planner to enable the daily limit": "プランナーで月間予算を設定すると1日の上限が有効になります",
    "You recorded no expenses on this day.": "この日は支出が記録されていません。",
    "Monthly Summary": "月間サマリー",
    "Updates automatically from calendar activity": "カレンダーの記録から自動更新",
    Income: "収入",
    Expense: "支出",
    Net: "差引",
    "Budget used": "予算使用率",
    "No-spend days": "支出ゼロの日数",
    "Event note": "予定メモ",
    "Event notes": "予定メモ",
    "Event Notes": "予定メモ",
    "Title (Payday, Trip, Shopping...)": "タイトル（給料日、旅行、買い物など）",
    "Add an optional note": "任意のメモを追加",
    "Add Note": "メモを追加",
    "No event notes for this day.": "この日の予定メモはありません。",
    "Delete event note": "予定メモを削除",
    "Your custom limit": "設定した上限",
    "Enter the amount you want to spend per day": "1日に使う金額を入力してください",
    "Custom daily expense limit": "1日の支出上限を設定",
    "Set Limit": "上限を設定",
    "Use Auto": "自動計算",
  },
  ko: {
    ...
    "days left": "일 남음",
    Saved: "저축됨",
    "Goal deadline": "목표 마감일",
    "Payment reminder": "결제 알림",
    "Recurring saving": "정기 저축",
    "Schedule & Reminders": "일정 및 알림",
    "Calendar event legend": "캘린더 일정 범례",
    "No-spend day": "무지출의 날",
    "No-spend": "무지출",
    "Low spending": "낮은 지출",
    "High spending": "높은 지출",
    "Spending heatmap": "지출 히트맵",
    "Daily budget limit": "일일 예산 한도",
    "Daily budget": "일일 예산",
    "Calculated from your Planner monthly budgets": "플래너의 월 예산을 기준으로 계산",
    "Set a monthly budget in Planner to enable the daily limit": "플래너에서 월 예산을 설정하여 일일 한도를 활성화하세요",
    "You recorded no expenses on this day.": "이 날에는 지출이 기록되지 않았습니다.",
    "Monthly Summary": "월간 요약",
    "Updates automatically from calendar activity": "캘린더 활동에서 자동 업데이트",
    Income: "수입",
    Expense: "지출",
    Net: "순액",
    "Budget used": "예산 사용률",
    "No-spend days": "무지출 일수",
    "Event note": "일정 메모",
    "Event notes": "일정 메모",
    "Event Notes": "일정 메모",
    "Title (Payday, Trip, Shopping...)": "제목 (급여일, 여행, 쇼핑 등)",
    "Add an optional note": "선택 메모 추가",
    "Add Note": "메모 추가",
    "No event notes for this day.": "이 날의 일정 메모가 없습니다.",
    "Delete event note": "일정 메모 삭제",
    "Your custom limit": "사용자 지정 한도",
    "Enter the amount you want to spend per day": "하루에 사용할 금액을 입력하세요",
    "Custom daily expense limit": "사용자 지정 일일 지출 한도",
    "Set Limit": "한도 설정",
    "Use Auto": "자동 계산",
  },
  my: {
    ...
    "days left": "ရက်ကျန်",
    Saved: "စုထားသည်",
    "Goal deadline": "Goal နောက်ဆုံးရက်",
    "Payment reminder": "ငွေပေးချေရန် သတိပေးချက်",
    "Recurring saving": "ပုံမှန်စုငွေ",
    "Schedule & Reminders": "အစီအစဉ်နှင့် သတိပေးချက်များ",
    "Calendar event legend": "Calendar အမှတ်အသားရှင်းလင်းချက်",
    "No-spend day": "အသုံးစရိတ်မရှိသောနေ့",
    "No-spend": "အသုံးမရှိ",
    "Low spending": "အသုံးနည်း",
    "High spending": "အသုံးများ",
    "Spending heatmap": "အသုံးစရိတ် Heatmap",
    "Daily budget limit": "နေ့စဉ် Budget ကန့်သတ်ချက်",
    "Daily budget": "နေ့စဉ် Budget",
    "Calculated from your Planner monthly budgets": "Planner ထဲက လစဉ် Budget များမှ တွက်ထားသည်",
    "Set a monthly budget in Planner to enable the daily limit": "နေ့စဉ် limit သုံးရန် Planner မှာ လစဉ် Budget သတ်မှတ်ပါ",
    "You recorded no expenses on this day.": "ဒီနေ့မှာ အသုံးစရိတ်မှတ်တမ်းမရှိပါ။",
    "Monthly Summary": "လစဉ် အနှစ်ချုပ်",
    "Updates automatically from calendar activity": "Calendar activity မှ အလိုအလျောက် update လုပ်သည်",
    Income: "ဝင်ငွေ",
    Expense: "သုံးငွေ",
    Net: "အသားတင်",
    "Budget used": "အသုံးပြုပြီး Budget",
    "No-spend days": "အသုံးမရှိသောနေ့များ",
    "Event note": "Event note",
    "Event notes": "Event notes",
    "Event Notes": "Event မှတ်စုများ",
    "Title (Payday, Trip, Shopping...)": "ခေါင်းစဉ် (လစာရက်၊ ခရီး၊ Shopping...) ",
    "Add an optional note": "လိုအပ်ပါက မှတ်စုထည့်ပါ",
    "Add Note": "မှတ်စုထည့်မည်",
    "No event notes for this day.": "ဒီနေ့အတွက် Event note မရှိပါ။",
    "Delete event note": "Event note ဖျက်မည်",
    "Your custom limit": "ကိုယ်တိုင်သတ်မှတ်ထားသော Limit",
    "Enter the amount you want to spend per day": "တစ်နေ့သုံးချင်သောပမာဏ ထည့်ပါ",
    "Custom daily expense limit": "ကိုယ်ပိုင်နေ့စဉ် အသုံးစရိတ် Limit",
    "Set Limit": "Limit သတ်မှတ်မည်",
    "Use Auto": "အလိုအလျောက်တွက်မည်",
  },
  zh: {
    ...
    "days left": "天剩余",
    Saved: "已储蓄",
    "Goal deadline": "目标截止日期",
    "Payment reminder": "付款提醒",
    "Recurring saving": "定期储蓄",
    "Schedule & Reminders": "日程与提醒",
    "Calendar event legend": "日历事件图例",
    "No-spend day": "无消费日",
    "No-spend": "无消费",
    "Low spending": "低消费",
    "High spending": "高消费",
    "Spending heatmap": "消费热力图",
    "Daily budget limit": "每日预算上限",
    "Daily budget": "每日预算",
    "Calculated from your Planner monthly budgets": "根据规划器中的月度预算计算",
    "Set a monthly budget in Planner to enable the daily limit": "在规划器中设置月度预算以启用每日上限",
    "You recorded no expenses on this day.": "这一天没有记录任何支出。",
    "Monthly Summary": "月度摘要",
    "Updates automatically from calendar activity": "根据日历活动自动更新",
    Income: "收入",
    Expense: "支出",
    Net: "净额",
    "Budget used": "预算使用率",
    ...
    "Event notes": "事件备注",
    "Event Notes": "事件备注",
    "Title (Payday, Trip, Shopping...)": "标题（发薪日、旅行、购物等）",
    "Add an optional note": "添加可选备注",
    "Add Note": "添加备注",
    "No event notes for this day.": "这一天没有事件备注。",
    "Delete event note": "删除事件备注",
    "Your custom limit": "自定义限额",
    "Enter the amount you want to spend per day": "输入每天计划支出的金额",
    "Custom daily expense limit": "自定义每日支出限额",
    "Set Limit": "设置限额",
    "Use Auto": "自动计算",
  },
};
...
const CLEAN_TRANSLATIONS = {
  ja: {
    ...
    "Pig Avatar": "ぶたアバター",
    "Bird Avatar": "鳥アバター",
    "Lion Avatar": "ライオンアバター",
    "Giraffe Avatar": "キリンアバター",
    "Panda Avatar": "パンダアバター",
    "Fox Avatar": "キツネアバター",
    ...
    "Unlock the lion avatar for new goals": "新しい目標で使えるライオンアバターを解放",
    "Unlock the giraffe avatar for new goals": "新しい目標で使えるキリンアバターを解放",
    "Unlock the panda avatar for new goals": "新しい目標で使えるパンダアバターを解放",
    "Unlock the fox avatar for new goals": "新しい目標で使えるキツネアバターを解放",
    Owned: "所持済み",
    "Need coins": "コイン不足",
    "Buying...": "購入中...",
    Buy: "購入",
